...
// for fast analytic queries. One row per bead_id. Pre-feature beads and
// in-flight beads may have NULL ready_at / started_at / closed_at — queries
// must guard against that when computing intervals.
