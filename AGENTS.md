...
- `bd create "Title" -p <priority> -t <type>` — create a bead
- `bd update <id> --claim` — claim a task
- `bd show <id>` — view task details
- `bd list --json --type epic` — list all epics

Epics (type=epic) are automatically synced to Linear. Do not create Linear issues manually for epics.
